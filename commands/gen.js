...
module.exports = {
	...
	description: 'Gen Tài Khoản Nếu Có.', // Command description
                ...
                fs.readFile(filePath, function (error, data) {
                    ...
                    if (!error) {
                        ...
                        message.author.send(
                            ...
                            .addField('Tài Khoản', `\`\`\`${firstLine}\`\`\``, true)
                            .setTimestamp()
                        )
                        .then(message.author.send('Tài Khoản Của Bạn Đây:'))
                        ...
                        if (position !== -1) {
                            ...
                            fs.writeFile(filePath, data, function (error) {
                                message.channel.send(
                                    ...
                                    .setDescription(`Kiểm tra riêng tư của bạn ${message.author}! *Nếu bạn không nhận được tin nhắn, vui lòng mở khóa riêng tư của bạn!*`)
                                    .setFooter(message.author.tag, message.author.displayAvatarURL({ dynamic: true, size: 64 }))
                                    .setTimestamp()
                                );
